export const CompactCardThumbnail = () => (
  ...
  >
    ...
    {/* Card outline */}
    <rect x="30" y="4" width="100" height="52" rx="4" fill="#3949ab" stroke="#5c6bc0" strokeWidth="2" />
    ...
    <rect x="96" y="10" width="26" height="26" rx="3" fill="#283593" stroke="#7986cb" strokeWidth="1" />
