...
module.exports = function (message) {
  ...
  if (msgArray.length <= 1) return message.channel.sendMessage(`To set your timezone, the syntax is \`${rssConfig.prefix}rsstimezone your_timezone_here\`. The default is \`${rssConfig.timezone}\`.\nSee <https://en.wikipedia.org/wiki/List_of_tz_database_time_zones> for a list of timezones under the TZ column.`);
