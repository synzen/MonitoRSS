const portOffset = Number(process.env.E2E_INSTANCE || 0) * 1000;

function e2ePort(name: string, defaultPort: number): number {
  return Number(process.env[name]) || defaultPort + portOffset;
}

export const MOCK_RSS_SERVER_PORT = e2ePort("E2E_MOCK_RSS_PORT", 3001);
...
export const MONGO_URI = `mongodb://127.0.0.1:${e2ePort("E2E_MONGO_PORT", 27019)}/rss`;
export const MOCK_DISCORD_SERVER_PORT = e2ePort("E2E_MOCK_DISCORD_PORT", 3002);
...
export const MOCK_REDDIT_SERVER_PORT = e2ePort("E2E_MOCK_REDDIT_PORT", 3006);
...
export const MOCK_SMTP_SERVER_PORT = e2ePort("E2E_MOCK_SMTP_PORT", 3004);
export const MOCK_SMTP_HTTP_PORT = e2ePort("E2E_MOCK_SMTP_HTTP_PORT", 3005);
