...
import { useUserFeed, useUserFeedArticles, UserFeedArticleRequestStatus } from "@/features/feed";

vi.mock("@/features/feed", async (importOriginal) => {
  const actual = await importOriginal<typeof import("@/features/feed")>();
    ...
    mockUseUserFeedArticles.mockReturnValue({
      data: {
        result: {
          ...
          totalArticles: 2,
          selectedProperties: ["title", "description", "link"],
