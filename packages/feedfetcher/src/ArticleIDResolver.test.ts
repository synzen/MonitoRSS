...
describe('Unit::ArticleIDResolver', function () {
  ...
  describe('constructor', function () {
    beforeEach(function () {
      spy.mockReturnValueOnce(idTypeNames as any);
    });
  ...
  describe('getIDType()', function () {
    beforeEach(function () {
      spy.mockReturnValue(idTypeNames as any);
    });
  ...
  describe('recordArticle()', function () {
    ...
    const getIdTypeValueSpy = jest.spyOn(ArticleIDResolver, 'getIDTypeValue');
    beforeAll(function () {
      getIdTypeValueSpy.mockReturnValue(mockArticleValue);
    });
    afterAll(function () {
      getIdTypeValueSpy.mockRestore();
    });
    ...
    it('deletes the id type from this.useIdTypes if there is no article value', function () {
      ...
      idResolver.idsRecorded.a = new Set();
      getIdTypeValueSpy.mockReturnValueOnce('');
      idResolver.recordArticle({});
