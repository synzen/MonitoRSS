...
1. Back up your MongoDB data (data migrations may occur)
...
To update to a specific version, add `MONITORSS_VERSION=7.0.0` (replacing with your desired version) to your `.env` file.

##### Major Version Updates

Docker compose files may change between major versions. Run `git pull` first to get the latest compose changes. If you've customized your compose file, you'll need to merge those changes.
