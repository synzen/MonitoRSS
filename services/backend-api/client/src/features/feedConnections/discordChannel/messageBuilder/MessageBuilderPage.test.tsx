...
import { TemplateRequiredField } from "../templates/types";
import { createDetectedFields } from "../templates/utils/detectedFieldsTestUtils";
...
vi.mock("../templates/components/TemplateGalleryModal", () => ({
