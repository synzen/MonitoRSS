          ...
          <ModalBody>
            ...
            <Stack spacing={4}>
              ...
              <FormControl isInvalid={!!errors.serverId}>
                <FormLabel>
                  {t('features.feed.components.addDiscordWebhookConnectionDialog.formServerLabel')}
                </FormLabel>
                <Controller
                  name="serverId"
                  control={control}
              ...
              <FormControl>
                ...
                <FormErrorMessage>
                  {errors.webhook.iconUrl.message}
                </FormErrorMessage>
                )}
                <FormHelperText>
                  {t(
