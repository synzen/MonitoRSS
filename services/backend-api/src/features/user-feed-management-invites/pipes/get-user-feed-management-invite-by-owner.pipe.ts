...
const createGetUserFeedManagementInviteByOwner = (): Type<PipeTransform> => {
  class Pipe implements PipeTransform {
    ...
    async transform(id: string) {
      ...
      const found = await this.service.getUserFeedOfInviteWithOwner(
        id,
...
export const GetUserFeedManagementInviteByOwnerPipe: () => Type<PipeTransform> =
  memoize(createGetUserFeedManagementInviteByOwner);
