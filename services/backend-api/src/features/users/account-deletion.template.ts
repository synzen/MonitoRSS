...
<h1 class="email-fg" style="margin:0 0 16px;font-size:21px;line-height:1.3;font-weight:700;color:${C.fg};">Confirm account deletion</h1>
<p class="email-muted" style="margin:0 0 16px;font-size:15px;line-height:1.6;color:${C.fgMuted};">Enter this code to confirm deletion of your MonitoRSS account:</p>
...
<tr><td style="height:20px;font-size:0;line-height:0;">&nbsp;</td></tr></table>
