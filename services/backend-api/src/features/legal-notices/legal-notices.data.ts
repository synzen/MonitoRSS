...
export const LEGAL_NOTICES: LegalNotices = LegalNoticesSchema.parse([
  {
    ...
    summary:
      "We've updated our Terms and Conditions and Privacy Policy, effective October 19, 2026. The updated documents reflect that Relayvale LLC operates the MonitoRSS hosted service, and clarify how your data is handled, your privacy rights, subscriptions and payments, and how disputes are resolved. Continued use of the MonitoRSS service on or after October 19, 2026 means you accept the updated documents.",
    documents: [
