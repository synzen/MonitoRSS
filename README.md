...
[Read the contribution guidelines](https://github.com/codeinteger6/Discord.RSS/blob/master/CONTRIBUTING.md). All the latest updates are commited to the dev branch. 
