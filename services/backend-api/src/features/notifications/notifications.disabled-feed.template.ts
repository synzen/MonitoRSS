/**
 * Set as a constant string instead of a HBS file since readFileSync may fail to read the file in docker builds
 * sometimes. Cause is unknown and appears to happen non-deterministically - current suspicion: https://github.com/nestjs/nest-cli/issues/1828
 */
const NOTIFICATIONS_DISABLED_FEED_TEMPLATE = `<html
lang="en"
...
export default NOTIFICATIONS_DISABLED_FEED_TEMPLATE;
