...
// leads, because prod data shows that is the real draw, not feed capacity. The
// limit-sharing value (shared feeds don't tax any member's personal limit) lives
// in the panel headline, so the teammate bullet carries the distinct other half:
// unlimited members at no per-seat cost. External properties is a
// <0.1%-of-feeds capability, so it sits last as an "and also". "Workspace" never
// appears as a bullet.
export const WORKSPACE_FEATURES: WorkspaceFeature[] = [
  { label: "Everything in Personal" },
  { label: "Add unlimited teammates, free" },
  {
