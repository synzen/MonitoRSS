  ...
  try {
    ...
    for (const rssName in rssList) {
      ...
      let o = {
        ...
        titleChecks: feed.titleChecks === true ? translate('commands.rsslist.titleChecksEnabled') : null
      }
    ...
    let desc = maxFeedsAllowed === 0 ? `${vipDetails}\u200b\n` : `${vipDetails}**${translate('commands.rsslist.serverLimit')}:** ${Object.keys(rssList).length}/${maxFeedsAllowed} [＋](https://www.patreon.com/discordrss)\n\n\u200b`
    desc += failedFeedCount > 0 ? translate('commands.rsslist.failAlert', { failLimit: FAIL_LIMIT, prefix: guildRss.prefix || config.bot.prefix }) : ''
