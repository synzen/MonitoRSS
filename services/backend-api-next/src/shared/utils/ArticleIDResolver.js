class ArticleIDResolver {
  constructor() {
     ...
     * seen before. If a article value was seen before in this set, then that placeholder should
     * be made invalid
    ...
    /**
     * Initially holds all possible ID types after instantiation. ID types are removed as
